...
The stakes are high: who pushed Captain Conrad overboard? Was it a deliberate act fueled by revenge, a tragic accident in a fit of passion, or part of a more elaborate scheme? Time is running out to piece together the clues before the yacht becomes a floating crime scene.
...
const suspects = [
  {
    name: "Sophia Seas",
    backstory: "The captain's first mate, known for her strict demeanor and unwavering loyalty. Recently, she discovered she had been passed over for a promotion, fueling her resentment toward Captain Conrad.",
    clues: [
  ...
  {
    name: "Victor Waves",
    backstory: "A rival yachtsman who had always envied Captain Conrad's success. He recently lost a high-stakes regatta to the captain, which humiliated him in front of the sailing community.",
    clues: [
  ...
  {
    name: "Dexter Deep",
    backstory: "A deckhand with a history of trouble, Dexter was recently reprimanded by the captain for neglecting his duties. Rumors about his temper had spread among the crew.",
    clues: [
  ...
  {
    name: "Mark Tide",
    backstory: "The ship's engineer, who discovered the yacht was scheduled for decommissioning. He blamed Captain Conrad for ruining his career prospects.",
    clues: [
  ...
  {
    name: "Gavin Gale",
    backstory: "A journalist looking for a big scoop. Gavin had been pestering the captain with questions about his personal life, making him visibly uncomfortable.",
    clues: [
      "His notepad had cryptic notes about a 'fall from grace.'",
      "He was spotted near the railing minutes before the incident.",
      "A tape recorder belonging to him had a partial recording of the argument.",
      "His press badge was found in the captain’s quarters."
    ],
  },
];
